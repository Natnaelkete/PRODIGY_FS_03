...
import useGetProductByIds from "../../hooks/products/getProductByIds";
import { formatCurrency } from "../../Utility/helpers";
import { useTheme } from "../../ui/useThemetoggler";

import { useDispatch, useSelector } from "react-redux";
import { addToCart, toggleColor } from "../cart/CartSlice";
  ...
  return (
    <div className="flex flex-col gap-10 standard:flex-row w-full">
      ...
      >
        ...
        <h3 className="text-xl">{formatCurrency(product.price)}</h3>
        <p className="flex flex-wrap  leading-8 mb-4">{product.description}</p>
        <div>Colors</div>
        <div className="">
